...
@objc public protocol GrowingTextViewDelegate: UITextViewDelegate {
    ...
    @objc optional func textViewDidChangeAttributedText(_ textView: GrowingTextView)
    //@objc optional func textViewDidReceiveMemoji(_ textView: GrowingTextView, image: UIImage)
}
